...
function getAngleType(angle) {
  ...
  // Case 2: Acute angle (less than 90)
  else if (angle < 90 && angle > 0) {
    return "Acute angle";
  }
  // Case 3: Obtuse angle (between 90 and 180)
  else if (angle > 90 && angle < 180) {
    return "Obtuse angle";
  }
  // Case 4: Straight angle (exactly 180)
  else if (angle === 180) {
...
// console.log(getAngleType(50));
// console.log(getAngleType(100));
